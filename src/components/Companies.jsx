...
export default function Companies() {
  return (
    <div className='flex flex-col text-white text-center py-24 bg-gradient-to-b from-[#222] to-[#000]'>
      ...
      <div className="flex justify-center md:flex-wrap sm:flex-wrap md:gap-16 sm:gap-16 sm:px-10 gap-24 lg:pb-20 pb-14">
      ...
      <p className='text-3xl md:text-xl sm:text-lg font-extrabold'>They choose Hotdesk to get their best work done.</p>
    </div>
  )
}
