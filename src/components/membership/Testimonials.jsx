					...
					>
						{testimonialSection.map((section) => (
							<div key={section.name}>
								<SwiperSlide>
									<div
										className='flex md:flex-col sm:flex-col mx-10 w-80% border-4 bg-white mb-20 text-black border-black sm:border-none my-32 sm:my-10 lg:mx-20 lg:divide-x-4 lg:divide-black'
									>
