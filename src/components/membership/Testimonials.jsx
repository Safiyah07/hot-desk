...
export const Testimonials = () => {
	return (
		<>
			<div className='bg-gradient-to-br from-[#c7f092] via-white to-[#92f0ce]'>
				<div className='pb-20'>
					<Swiper
						modules={[Pagination]}
						spaceBetween={10}
					...
					>
						<SwiperSlide>
							<div className='flex md:flex-col sm:flex-col mx-10 w-80% border-4 bg-white mb-20 text-black border-black sm:border-none mt-32 sm:my-10 lg:mx-20 lg:divide-x-4 lg:divide-black'>
